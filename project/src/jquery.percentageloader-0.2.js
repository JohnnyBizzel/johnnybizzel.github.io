        ...
        * than true / false */
        ...
        drawLoader = function () {
            ...
            (function () {
                ...
                fontSize = cX / 5; // was divided by 2

                percentageText.style.top = ((settings.height / 1.18) - (fontSize / 5)).toString() + 'px'; // height was / 2
                ...
                smallSize = cX / 2.5; // was divided by 5.5
                 ...
                 * The bottom ring occupies 1/6 of the diameter of the circle */
                heightRemaining = (settings.height * 0.46666666) - smallSize; // was * 0.1666
                valueText.style.top = ((settings.height * 0.31) + (heightRemaining / 4)).toString() + 'px'; // was * 0.8333
            }());
        };
